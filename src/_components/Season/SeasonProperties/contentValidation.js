export const manageDropDownValidation = (stepName, name, value) => {
  ...
  if (name == "isMultiAudio") {
    shallowArr.map(obj => (obj.name == "audioLanguages") ? value ?
      ((obj.multiple = true), (obj.value = obj.value?.length ? obj.value: obj.value? [obj.value] : []),
      (obj.initialValue = obj.value?.length ? obj.value : obj.value? [obj.value] : [])) :
      ((obj.multiple = false), (obj.value = null), (obj.initialValue = null)) : obj);
