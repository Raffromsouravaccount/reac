                            ...
                            <div className="wrap-edit-img">
                              ...
                              <span className="invalid-image">
                                ...
                                {imageItem?.imageData?.url && imageItem?.imageData?.url.length ?
                                    <img src={completeImagePath( imageUpload ? seasonExternalId:externalId, imageItem.imageData.key, imageItem.imageData.url, imageItem.imageData.resolution)} alt="avatar" />
                                    :
