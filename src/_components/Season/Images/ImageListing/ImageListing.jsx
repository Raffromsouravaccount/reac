...
class ImagesListing extends Component {
    ...
    getImageUploadView = () => {
        ...
        return (
            <div className="upload-block flex justify-content-center">
                <button className="upload-btn auto-upload-btn" onClick={this.onFileUpload}>
    ...
    render() {
        ...
        const isImageUploaded = (item?.url && item?.url.length > 0);
        return (
                ...
                <div className="item-con">
                    <div className="item-head flex align-items-center justify-content-between">
                        ...
                        {isImageUploaded ?
                            ...
                            :
                            item?.mandatory && <div className="item-mandatory">{constantText.create_movie_req_images_text}</div>
                        }
                    </div>
