...
import { addEditImage } from '../../../Schema/Image.json';
...
class ViewEditImageModal extends Component {
    constructor(props) {
        super(props);
        this.state = {
            addEditImageJson: JSON.parse(JSON.stringify(addEditImage)),
                ...
                <div className="photo-box">
                    <div className="head">
                        {viewEditModalMode == 'view' &&
                            <span>
                                <span> {imageItem && imageItem.imageData.title} {imageItem && imageItem.imageData.resolution} </span>
                    ...
                    <div className="photo-content">
                        <div className="row padd-bot20">
                            ...
                            {viewEditModalMode == 'edit' &&
                                <div className="col-text col-sm-7 col-md-7">
                                    <div className="flex justify-content-between main-cover-text">
                                        <strong> {imageItem && imageItem.imageData.title}&nbsp;&nbsp;&nbsp;{imageItem && imageItem.imageData.resolution}  </strong>
                                        <strong> {imageItem && imageItem.imageData.size} </strong>
                                    </div>
                                    <FormRender
