...
import { createSet } from '../../../Schema/Image.json';
import AngleLeftArrow from "images/angle-left-arrow.svg";
import TagIcon from "images/tag-icon.svg";
import "../../../../../../public/css/Common/ImageSet.css";
class ImageSetCreate extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      formFieldsJson: JSON.parse(JSON.stringify(createSet)),
  ...
  createSet = async (e) => {
    ...
    if (this.props.editSet && this.props.editSet.setName) {
      ...
      url = url + '/' + this.props.collectionId;
      ...
      let dataParams = { contentId: this.props.collectionId, imageSets: dataObj };
    ...
    return (
      <div className="whitebox">
        ...
        <CommonModel
            ...
            />
          <span className="back-arrow"  onClick={() => this.showCommonPopUp()}><AngleLeftArrow /></span>
