...
class ViewLicenceModule extends Component {
  ...
  render() {
    const { licenceList, filters, videoId, contentId } = this.state;
    const { searchVal } = filters;
    const { handleRoute, stage } = this.props;
    let { canUpdate } = permissionObj?.tvShows?.licenceModule;
    return (
            ...
            <div className="status-head flex align-items-center">
              ...
              <div className="edit-btn">
                 <ButtonField
                    ...
                    onClick={() =>
                      canUpdate()
                        ? handleRoute(`${Config.tvShow.edit}/${contentId}`)
                        : ""
                    }
                  />
              </div>
                ...
                <div className="left-area">
                  <div className="text-data row">
                    <div className="col-md-12 col-lg-6 flex">
                      ...
                      <div className="text">
                        {license_item
                          ? moment(license_item.fromDate).format(
                    ...
                    <div className="col-md-12 col-lg-6 flex">
                      ...
                      <div className="text">
                        {license_item
                          ? moment(license_item.toDate).format(
                              constantText.date_format_without_time
                            )
                          : ""}
                      </div>
...
const mapStateToProps = (state) => {
  var licenseList = state.tvShows_reducer.licenseRecords;
  return {
    licenseList,
  };
};
...
const actionCreators = {
  getLicenceData: tvShowsActions.list_license_action,
};
