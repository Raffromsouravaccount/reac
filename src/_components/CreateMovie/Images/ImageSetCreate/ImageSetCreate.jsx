...
class ImageSetCreate extends Component {
  ...
  createSet = async (e) => {
    ...
    if (this.props.editSet && this.props.editSet.setName) {
      ...
      let dataParams = { contentId: this.props.contentId, imageSets: dataObj };
    ...
    return (
      <div className="whitebox">
        ...
        <CommonModel
            ...
            />
          <span className="back-arrow auto-back-btn" onClick={() => this.showCommonPopUp()}><AngleLeftArrow /></span>
