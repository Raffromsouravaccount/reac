...
class TitleSummary extends Component {
  ...
  handleChange = (event, ...rest) => {
    console.log("value", event.target.value, "rest", ...rest);
  }
      ...
      <div className="movie-f-wrap">
        <div className="whitebox m-b-30">
          <div className="col-12">
            <div className="row input-space-35">
              <FormRender
                form={title_summary} serverCall={true} id="formRenderOnChange"
        ...
        <div className="whitebox m-b-30">                      
          ...
          <div className="col-12">
              {this.getMultipleSectionUI('specialCategory', specialCategory, null, addRemoveSpecialCategory, selectGroup)}
          </div>
        </div> }
        {(global && global.length > 0) &&
          <div className="whitebox m-b-30">
            ...
            <div className="col-12">
              <div className="row input-space-35">
                <FormRender
                  form={global} serverCall={true} id="globalFormRender"
                  sectionMultipleBlock={this.getMultipleSectionUI('groupWiseTitle', groupWiseTitle,
