...
import Season from '../../../../_components/Common/Season/Season';
...
const setup = (props = {}, state = {}) => {
  const wrapper = shallow(<Season {...baseProps} />)
  return wrapper;
}
...
describe('Season', () => {
  ...
  it('should check click method checkBoxHandler', () => {
    ...
    const wrapper = shallow(<Season {...baseProps}  handleCheckBox={checkBoxHandler}/>)
