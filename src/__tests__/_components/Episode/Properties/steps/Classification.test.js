...
import Classification from '../../../../../_components/Episode/Properties/Steps/Classification';
...
describe('Classification', () => {
  ...
  it('should check handleChange onChange method for awards section', () => {
    wrapper.find('#classificationBtn').first().simulate('change');
    expect(baseProps.handleChange).toHaveBeenCalled();
  })

  it('should check onChange method of handleAutoCreateInput for awards section', () => {
    const myFakeCallback = () => {};
    wrapper.find('#classificationBtn').first().prop('handleAutoCreateInput')(myFakeCallback)
  })

  it('should check onChange method of setSelectDataArr for awards section', () => {
    const myFakeCallback = () => {};
    wrapper.find('#classificationBtn').first().prop('setSelectDataArr')(myFakeCallback)
  })
