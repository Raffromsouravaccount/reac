...
import ImageSets from "../../../../../_components/Episode/Images/ImageSets/ImageSets";
...
describe("render", () => {
  ...
  it("should check the getImageListingView with params else if", () => {
    const image = {
      imageDescription: "",
      imagePresetId: "84930878-152f-4110-89fc-432425f94205",
      imageTitle: "",
  ...
  it("should check the getImageListingView with params else", () => {
    const image = {
      imageDescription: "",
      imagePresetId: "84930878-152f-4110-89fc-432425f94205",
      imageTitle: "",
  ...
  it('should check btn1Action', () => {
    ...
    wrapper.find('#common-model').first().prop('btn1Action')(myFakeCallback);
  })
  ...
  it('should check btn1Action for showmodel true', () => {
    const model = {
      showModel : true
    }
    wrapper.setState({model:  model });
    const myFakeCallback = () => {};
    wrapper.find('#confirmationPopupClose').first().prop('btn1Action')(myFakeCallback);
  })

  it('should check btn2Action for showmodel true', () => {
    const model = {
      showModel : true
    }
    wrapper.setState({model:  model });
    const myFakeCallback = () => {};
    wrapper.find('#confirmationPopupClose').first().prop('btn2Action')(myFakeCallback);
  })
  
  it('should check handleClose for showmodel true', () => {
    const model = {
      showModel : true
    }
    wrapper.setState({model:  model });
    const myFakeCallback = () => {};
    wrapper.find('#confirmationPopupClose').first().prop('handleClose')(myFakeCallback);
  })
  ...
  it('should check getEpisodeData', () => {
    wrapper.setProps({episodeId: '12'})
    jest.spyOn(wrapper.instance(), 'getEpisodeData');
    wrapper.instance().getEpisodeData();
    expect(wrapper.instance().getEpisodeData).toBeCalled();
  })
  ...
  it('should check clicked', () => {
    const myFakeCallback = () => {};
    wrapper.find('#toggleLock').first().prop('clicked')(myFakeCallback);
  })
