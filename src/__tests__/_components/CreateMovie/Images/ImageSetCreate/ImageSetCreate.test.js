...
import ImageSetCreate from '../../../../../_components/CreateMovie/Images/ImageSetCreate/ImageSetCreate';
...
const props = {
  ...
  imageSets: [{
    ...
    setName: "Default",
    tags: { others: null },
    videoId: "08ff3701-d67c-482c-be77-238769f6e87c"
  },
  {
...
describe('render', () => {
  ...
  it('should check createSet method', () => {
    wrapper.setState({
      formFieldsJson: JSON.parse(JSON.stringify(jsonData?.Images?.createSet))
    });
    const instance = wrapper.instance();
  ...
  it('should check createSet method else', () => {
    wrapper.setProps({videoId:'xyz', editSet: {}})
    wrapper.setState({
      formFieldsJson: JSON.parse(JSON.stringify(jsonData?.Images?.createSet))
    });
    const instance = wrapper.instance();
  ...
  it('should check method of showCommonPopUp', () => {
    const instance = wrapper.instance();
    jest.spyOn(instance, 'showCommonPopUp');
    instance.showCommonPopUp();
    expect(instance.showCommonPopUp).toHaveBeenCalled();
  })
