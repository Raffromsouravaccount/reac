...
describe('<RelatedContent />', () => {
    ...
    beforeEach(() => {
        ...
        movieService.post_related_content = jest.fn().mockReturnValue([{}])
        movieService.delete_related_content = jest.fn().mockReturnValue([{}])
        movieService.get_related_content = jest.fn().mockReturnValue([{}])
        movieService.rearrange_related_content = jest.fn().mockReturnValue([{}])
        movieService.update_related_content_rearrange_content = jest.fn().mockReturnValue([{}])
        wrapper = setup();
    })
