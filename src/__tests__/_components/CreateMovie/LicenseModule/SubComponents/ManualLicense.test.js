...
import ManualLicense from '../../../../_components/CreateMovie/LicenseModule/SubComponents/ManualLicense';
...
describe('ManualLicense', () => {
  ...
  it('should check handleDeleteTemplate method', () => {
    const instance = wrapper.instance();
    jest.spyOn(instance, 'handleDeleteTemplate');
    instance.handleDeleteTemplate();
    expect(instance.handleDeleteTemplate).toHaveBeenCalled();
  })
