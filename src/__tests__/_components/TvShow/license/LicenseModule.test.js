...
import LicenseModule from "../../../../_components/TvShow/LicenseModule/LicenseModule";
...
describe("LicenseModule", () => {
  ...
  it('should test InputChangerCommonable',()=>{
    ...
    // const wrapper = setup();
   wrapper.setState({commonmodel_section:commonmodel_section})
   const instance = wrapper.instance();
   jest.spyOn(instance, 'InputChangerCommonable');
   instance.InputChangerCommonable(event,0);
   expect(instance.InputChangerCommonable).toHaveBeenCalledTimes(1);
 });
  ...
  it("should check validateUserCountries method", () => {
    const event = { target: { name: "handleChange", value: "test" } };
    const instance = wrapper.instance();
    jest.spyOn(instance, "validateUserCountries");
    instance.validateUserCountries(event);
    expect(instance.validateUserCountries).toHaveBeenCalled();
  });
  ...
  it("should test componentDidMount ", () => {
    const licenseData = {
      ...
      country: [
        ...
        [{ id: "cc345c9b-335e-4283-ac51-c603e0bbe7d6", title: "Cameroon" }],
        [
          {
            id: "d3044dbd-1dd8-4cda-8602-e4e03f4b557b",
            title: "Central African Republic",
        ...
        [{ id: "aa271ec3-faff-46ac-aa6d-bdda1862e228", title: "Chad" }],
        ...
        [{ id: "c1e23d4f-cdf2-4f9c-857a-adaf2f2d4f67", title: "Gabon" }],
        [{ id: "ba7216dd-51cb-40d3-808a-cfc0b4597752", title: "Botswana" }],
        [{ id: "cd56aa76-153a-43b1-9393-2ece61ccefe0", title: "Namibia" }],
        [{ id: "386588f9-0080-4d4a-9b7c-7f2d1dc60c77", title: "South Africa" }],
        [{ id: "0ea03c08-7086-4519-814c-e4333581ba8d", title: "Swaziland" }],
      ],
      fromDate: "2021-04-20T00:00:00.000Z",
      platform: [
        [{ id: "0b4bf044-b439-4c98-8fa3-f4a15e9eab3d", title: "KaiOS" }],
      ],
      reason: { title: null, id: null },
      toDate: "2021-04-25T00:00:00.000Z",
      tvodTier: { title: null, id: null },
      id: "6f42817b-2778-4053-83b3-c3f990e0e240",
      currentStatus: "1",
      createdBy: "",
      updatedBy: "",
      updatedByEmail: "",
  ...
  it("should test InputChanger", () => {
    const event = {
      target: { name: "setName", files: [{ path: "test/image/path" }] },
    };
