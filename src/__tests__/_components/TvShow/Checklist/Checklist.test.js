...
import CheckListComp from '../../../../_components/TvShow/Checklist/Checklist';
...
describe("CheckList Component", () => {
  ...
  it("Should call getShowDetails API", (done) => {
    const response = {
      response: {
        status: 200,
        data: {
          contentState: {title: "Draft", id: "21f691eb-d73c-4ba2-a20f-59ac1dfd0ffe"},
        }
      }
    }
    wrapper.instance().getShowDetails();
  ...
  it("Should call getShowHistory API", (done) => {
    const response = {
      response: {
        status: 200,
        data: {
    ...
    wrapper.instance().getShowHistory();
    moxios.wait(function () {
  ...
  it("Should call getAllStatesStatus API", (done) => {
    const response = {
      response: {
        status: 201,
        data: [
          {id: "6c0aba29-72fc-493e-af61-b33d9ae63f83", isDone: true, sectionName: "relatedContent"},
          {id: "6c0aba29-72fc-493e-af61-b33d9ae63f23", isDone: true, sectionName: "collectionAssignment"}
        ]
      }
    }
