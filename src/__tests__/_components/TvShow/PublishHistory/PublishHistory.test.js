...
import PublishHistoryTvShow from '../../../../_components/TvShow/PublishedHistory/PublishedHistoryTvShow';
...
const setup = (props = {}, state = null) => {
   const wrapper = shallow(<PublishHistoryTvShow {...props}/>)
    return wrapper;
  }

describe('<PublishHistoryTvShow/>',()=>{
    let wrapper;
      beforeEach(()=>{
          wrapper = setup();
      });
