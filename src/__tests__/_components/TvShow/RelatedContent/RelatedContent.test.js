...
import RelatedContent from '../../../../_components/TvShow/RelatedContent/RelatedContent';
...
describe('<RelatedContent />', () => {
    ...
    it('should test getTvShowRelatedContentStatus', () => {
        const testComp = wrapper.instance();
        jest.spyOn(testComp, 'getTvShowRelatedContentStatus');
        testComp.getTvShowRelatedContentStatus();
        expect(testComp.getTvShowRelatedContentStatus).toHaveBeenCalledTimes(1);
    })
