...
import ImageSets from "../../../../../_components/TvShow/Images/ImageSets/ImageSets";
...
describe("render", () => {
  ...
  it("should check the getTvShowData ",(done) => {
    const response = {
      imageSets: [
        {
          default: true,
    ...
    const instance = wrapper.instance();
    jest.spyOn(instance, "getTvShowData");
    instance.getTvShowData();
    expect(instance.getTvShowData).toBeCalled();
