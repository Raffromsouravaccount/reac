...
import CollectionAssignment from '../../../../_components/TvShow/CollectionAssignment/CollectionAssignment';
...
describe('<CollectionAssignment />', () => {
    ...
    it('should test getTVShowCollectionAssignmentStatus', () => {
        const testComp = wrapper.instance();
        testComp.setState({ contentId: contentId, userID: '123' })
        jest.spyOn(testComp, 'getTVShowCollectionAssignmentStatus');
        testComp.getTVShowCollectionAssignmentStatus();
        expect(testComp.getTVShowCollectionAssignmentStatus).toHaveBeenCalledTimes(1);
    })
