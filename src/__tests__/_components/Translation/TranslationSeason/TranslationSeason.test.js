...
import SeasonCastNCrewJson from "../../../../_components/Translation/Schema/Season/CastNCrew.json";
import SeasonTemplateJson from "../../../../_components/Translation/Schema/Season/Template.json";
import SeasonGlobalContentPropertiesJson from "../../../../_components/Translation/Schema/Season/GlobalContentProperties.json";

const setup = (props = {}, state = null) => {
    const wrapper = shallow(<TranslationSeason {...props} />)
    if (state) wrapper.setState(state);
    return wrapper;
}
const initialState = {
    params:{
        seasonId: "95064119-70d8-43bd-a1a7-07e93c149667",
    },
...
describe('<TranslationSeason />', () => {
    ...
    it('Should renders Translation Season default', () => {
    ...
    it('should test fetchContentData with defaultData', async () => {
        ...
        const wrapper = setup({}, {...initialState});
        const seasonId = initialState.params.seasonId;
        const sections = constantText.translations.season_sections;
        ...
        const result = await translationService.getShowDetails(seasonId, lang, sections[wrapper.state('selectedSecTab')].url);
        const instance = wrapper.instance(); 
    ...
    it('should test fetchContentData with defaultData for globalFields', async () => {
        ...
        const globalSections = constantText.translations.season_global_sections;
        const instance = wrapper.instance(); 
        jest.spyOn(instance, 'fetchContentData'); 
        instance.fetchContentData(true);
        expect(instance.fetchContentData).toHaveBeenCalledWith(true);
    ...
    it('should test fetchContentData with defaultData for castAndCrew', async () => {
        ...
        const wrapper = setup({}, {...initialState, selectedSecTab: 1, fields: JSON.parse(JSON.stringify(SeasonCastNCrewJson))});
        const seasonId = initialState.params.seasonId;
        const sections = constantText.translations.season_sections;
        const isDefaultData = true;
        const lang = isDefaultData ? String(Config.defaultLanguageCode) : String('hi');
    ...
    it('should test fetchContentData with defaultData for template', async () => {
        const response = {"status":200,"message":"Template translation data has been successfully fetched.","data":{"id":"0023bef4-9b4c-49ab-9a81-68f220f16937","title":"Show name + ReleaseDate+EpisodeNumber+AssetType","seasonId":"68c04d51-7876-4a80-824a-4960ece780bd","shortDescription":"<p>fdfd</p>","subtypeId":"855fa5db-960b-4c33-af1d-9c52870fc2a7","mapCollectionId":["1efcfe81-b3d9-4e63-a9dd-b29fa5583b96","b20de611-1b9c-4dae-93ca-1e441e16e406"],"createdBy":"f359a39e-ce44-4b57-ace3-2b457de116b2","modifiedBy":"f359a39e-ce44-4b57-ace3-2b457de116b2","status":"1","_created_on":"2021-03-22T08:32:21.118Z","_modified_on":"2021-03-22T08:32:21.118Z"},"error":null};
        const wrapper = setup({}, {...initialState, selectedSecTab: 2, fields: JSON.parse(JSON.stringify(SeasonTemplateJson))});
        const seasonId = initialState.params.seasonId;
        const sections = constantText.translations.season_sections;
        const isDefaultData = true;
        const lang = isDefaultData ? String(Config.defaultLanguageCode) : String('hi');
    ...
    it('should test updateValues for template', () => {
        const resData = [{'title': "cc"}];
        const isDefaultData = false;
        const wrapper = setup({}, {...initialState, selectedSecTab: 2, fields: JSON.parse(JSON.stringify(SeasonTemplateJson))});
        const instance = wrapper.instance();
    ...
    it('should test updateValues for global Fields', () => {
        ...
        const response = [];
        const isDefaultData = false;
        const wrapper = setup({}, {...initialState, defaultData: response, selectedGlobalSecTab: 1, fields: JSON.parse(JSON.stringify(SeasonGlobalContentPropertiesJson))});
        const instance = wrapper.instance();
        jest.spyOn(instance, 'updateValues');
        instance.updateValues(resData);
        expect(isDefaultData).toBeFalsy();
    ...
    it('should test lockSections', () => {
        ...
        instance.lockSections(params?.seasonId);
        expect(instance.lockSections).toHaveBeenCalledWith(params?.seasonId);
    ...
    it('should test autoSave', (done) => {
        const response = {
            response: {
                status: 201,
                data: [{"title":{"value":"iu kk mm","inherited":false}},{"shortDescription":{"value":"<p>gfh season</p>","inherited":false}},{"webDescription":{"value":null,"inherited":true}},{"appDescription":{"value":null,"inherited":true}},{"tvDescription":{"value":null,"inherited":true}},{"creativeTitle":{"value":null,"inherited":true}},{"alternativeTitle":{"value":null,"inherited":true}},{"pageTitle":{"value":null,"inherited":true}},{"pageDescription":{"value":null,"inherited":true}},{"socialShareTitle":{"value":null,"inherited":true}},{"socialShareDescription":{"value":null,"inherited":true}},{"upcomingPageText":{"value":"trt upp","inherited":false}},{"trivia":{"value":"tt tfsf","inherited":false}},{"actorCharacter":{"value":[{"actor":"Akshay","character":"","inherited":false},{"actor":"samar thakur","character":"hrd hh pp","inherited":false}]}},{"translationStatus":"1"}]
            }
        };
        const updatedFields = {
            "name": "title",
    ...
    it('should test autoSave for CastNcrew', (done) => {
        ...
        const fields = JSON.parse(JSON.stringify(SeasonCastNCrewJson));
        const actorData = {
            ...fields,
            "actors":[
    ...
    it('should test autoSave for template', () => {
        const wrapper = setup({updateMarkAsDoneAction: jest.fn()}, {...initialState, selectedSecTab: 2, fields: JSON.parse(JSON.stringify(SeasonTemplateJson))});
        const instance = wrapper.instance();
        jest.spyOn(instance, 'autoSave');
        instance.autoSave();
        expect(instance.autoSave).toHaveBeenCalledTimes(1);
    ...
    it('should test getSeasonStatus', async (done) => {
        const response = {
            response: {
                status: 201,
                data: [{"id":"f61d5eec-ac5d-491e-8259-d2b703599a64","seasonId":"95064119-70d8-43bd-a1a7-07e93c149667","sectionName":"hi_properties","isLocked":true,"lockedBy":"f359a39e-ce44-4b57-ace3-2b457de116b2","lockedOn":"2021-03-02T12:01:43.533Z","isDone":false,"doneBy":null,"doneOn":null,"createdBy":"f359a39e-ce44-4b57-ace3-2b457de116b2","modifiedBy":"f359a39e-ce44-4b57-ace3-2b457de116b2","status":"1","_created_on":"2021-03-02T12:01:43.520Z","_modified_on":"2021-03-02T12:01:43.520Z","lockedByUser":{"id":"f359a39e-ce44-4b57-ace3-2b457de116b2","firstName":"Tanuj","lastName":"Kumar"}}]
            }
        };
        const wrapper = setup({}, { ...initialState });
        const instance = wrapper.instance();
    ...
    it('should test getTemplateTypeId', (done) => {
        const response = {
            response: {
                status: 200,
                data: [{"title":"Best Scene","status":"1","id":"855fa5db-960b-4c33-af1d-9c52870fc2a7"},{"title":"Clip","status":"1","id":"5b44c8f7-1166-465f-a56c-ae03a08bb505"},{"title":"Episode","status":"1","id":"3ac2b4c9-9708-4864-b9ae-1a191cdd9ef0"},{"title":"mobisode","status":"1","id":"5b44c8f7-1166-465f-a56c-ae03a08bb502"},{"title":"Preview","status":"1","id":"f9c605c9-ef17-4068-8c5d-fc7061dd61e0"},{"title":"Promo","status":"1","id":"5b44c8f7-1166-465f-a56c-ae03a08bb506"},{"title":"teaser","status":"1","id":"5b44c8f7-1166-465f-a56c-ae03a08bb507"},{"title":"Webisode","status":"1","id":"5b44c8f7-1166-465f-a56c-ae03a08bb501"}]
            }
        };
        const templateSection = 'episode';
        const wrapper = setup({}, {...initialState, selectedSecTab: 2, fields: JSON.parse(JSON.stringify(SeasonTemplateJson))});
        const instance = wrapper.instance();
        const section = wrapper.state('sections')[wrapper.state('selectedSecTab')];
        jest.spyOn(instance, 'getTemplateTypeId');
        instance.getTemplateTypeId(templateSection);
        moxios.wait(function () {
            const request = moxios.requests.mostRecent();
            request.respondWith(response).then((res) => {
                done();
        ...
        expect(instance.getTemplateTypeId).toHaveBeenCalledTimes(1);
        expect(section.url).toEqual('template');
    });
    ...
    it('Sholud test actionButtonsHandler for castNcrew', () => {
        ...
        const wrapper = setup({}, {...initialState, fields: JSON.parse(JSON.stringify(SeasonCastNCrewJson))});
        const instance = wrapper.instance();
        jest.spyOn(instance, 'actionButtonsHandler');
        instance.actionButtonsHandler(key, rootIndex, index, data, 'save', false);
        expect(instance.actionButtonsHandler).toHaveBeenCalledTimes(1);
