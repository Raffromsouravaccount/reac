...
import PublishHistory from '../../../../_components/Video/PublishHistory/PublishedHistory';
...
describe('<PublishHistory/>',()=>{
    let wrapper;
      ...
      it('Should render Publish History Tv Show default',()=>{
      ...
      it('should test fetchLicenseData',()=>{
        ...
        wrapper.setState({...mockSet.isRequestIntiate});
        wrapper.setProps({...mockSet.props})
        const instance = wrapper.instance();
      ...
      it('should test handlePublishHistoryRoute with state view',()=>{
        const mockSet = {
          state : "view"
        }
