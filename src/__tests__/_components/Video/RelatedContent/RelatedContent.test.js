...
import RelatedContent from '../../../../_components/Video/RelatedContent/RelatedContent';
...
describe('<RelatedContent />', () => {
    ...
    beforeEach(() => {
        ...
        videoService.post_related_content = jest.fn().mockReturnValue([{}])
        videoService.delete_related_content = jest.fn().mockReturnValue([{}])
        videoService.get_related_content = jest.fn().mockReturnValue([{}])
        videoService.rearrange_related_content = jest.fn().mockReturnValue([{}])
        videoService.update_related_content_rearrange_content = jest.fn().mockReturnValue([{}])
        wrapper = setup();
    })
    ...
    it('should test getMovieRelatedContentStatus', () => {
        const testComp = wrapper.instance();
        jest.spyOn(testComp, 'getMovieRelatedContentStatus');
        testComp.getMovieRelatedContentStatus();
        expect(testComp.getMovieRelatedContentStatus).toHaveBeenCalledTimes(1);
    })
