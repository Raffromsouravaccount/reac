...
import RelatedContent from '../../../../_components/Season/CreateSeason/RelatedContent/RelatedContent';
...
const setup = (
    props = {
        match: { params: { seasonId: contentId } },
        history: { goBack: () => { } }
    },
...
describe('<RelatedContent />', () => {
    ...
    it('should test getSeasonRelatedContentStatus', () => {
        const testComp = wrapper.instance();
        jest.spyOn(testComp, 'getSeasonRelatedContentStatus');
        testComp.getSeasonRelatedContentStatus();
        expect(testComp.getSeasonRelatedContentStatus).toHaveBeenCalledTimes(1);
    })
