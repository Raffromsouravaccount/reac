...
import CheckListComp from '../../../../_components/Season/Checklist/Checklist';
...
describe("CheckList Component", () => {
  ...
  it("Should call getSeasonDetails API", (done) => {
    const response = {
      response: {
        status: 200,
        data: {
          contentState: {value:{title: "Draft", id: "21f691eb-d73c-4ba2-a20f-59ac1dfd0ffe"}},
        }
      }
    }
    wrapper.instance().getSeasonDetails();
