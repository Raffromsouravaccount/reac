...
import GlobalFields from '../../../../../_components/Season/SeasonProperties/Steps/GlobalFields'
...
describe('GlobalFields', () => {
  ...
  it('should check addRemoveMultipleFields onClick method', () => {
    ...
    expect(baseProps.addRemoveMultipleFields).toHaveBeenCalledTimes(0);
  })
  ...
  it('should check handleChange onChange method', () => {
    ...
    expect(baseProps.handleChange).toHaveBeenCalledTimes(0);
  })
