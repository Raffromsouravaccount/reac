...
import ControlFields from '../../../../../_components/Season/SeasonProperties/Steps/ControlFields';
...
describe('ControlFields', () => {
    ...
    const controlFieldsData = [
        {
            createdAt: "2021-01-29T10:29:15.145Z", createdBy: { first_name: "Test", last_name: "" },
            lastModifiedBy: { first_name: "Test", last_name: "" }, lastModifiedOn: "2021-01-29T10:29:15.145Z"
        }
    ]
    const baseProps = {
        handleTab: jest.fn(),
    ...
    it('should test getControlFieldsByPropName', () => {
        const controlFieldsData = {
            scheduleHistory: [{ name: 'scheduleHistory', value: "mockValue" }, { name: 'scheduleHistory', value: "mockValue" }]
        }
