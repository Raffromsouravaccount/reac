...
import { LicenseModule, mapStateToProps } from '../../../../_components/Collection/CreateCollection/LicenseModule/LicenseModule';
...
describe('<LicenseModule />', () => {
  ...
  beforeEach(() => {
    ...
    componentDidMountSpy = jest.spyOn(LicenseModule.prototype, 'componentDidMount');
    componentWillReceivePropsSpy = jest.spyOn(LicenseModule.prototype, 'componentWillReceiveProps');
  });
  afterEach(() => {
    jest.clearAllMocks();
  });
